...
2. It is standard to create a folder called plugins, this is where the library files should be located, the DLL file and an associated metafile. They can be found in the git repository connectAPI.
